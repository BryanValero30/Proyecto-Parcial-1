...
items.forEach(item => {
  item.addEventListener('click', () => {
   ...
   // Falta Carga el html
      case 'materias':
        title = 'Materias';
        text = 'Administra las materias disponibles en el sistema.';
        break;
  // FaltaCarga el html
      case 'profesores':
  ...
  // FaltaCarga el html
      case 'calificaciones':
        ...
        text = 'Revisa y modifica las calificaciones de los estudiantes.';
        break;
...
// Carga el HTML, JS y CSS solo de la sección de estudiante
    ...
    .catch(err => {
      document.getElementById("mainContent").innerHTML = "<p>Error al cargar la sección.</p>";
      console.error(err);
    });


// Agregar la carga del HTML, JS y CSS solo de la sección de materias



// Agregar la carga del HTML, JS y CSS solo de la sección de profesores
...
// Agregar la carga del HTML, JS y CSS solo de la sección de calificaciones